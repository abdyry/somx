        ...
        $array = [
            ...
            'payment_methods' => [
                'web' => [
                    ...
                    'withdrawal' => [Paypal, Bank, Crypto, Hormuud, Somtel, PremierWallet],
                    'fiat' => [
                        'deposit' => [Mts, Stripe, Paypal, PayUmoney, Bank, Coinpayments, Payeer, Coinbase, Hormuud, Somtel, PremierWallet],
                        'withdrawal' => [Mts, Paypal, Bank, Hormuud, Somtel, PremierWallet, Cash],
                    ],
                    'crypto' => [
                ...
                'mobile' => [
                    ...
                    'withdrawal' => ['Paypal' => Paypal, 'Bank' => Bank, 'Hormuud' => Hormuud, 'Somtel' => Somtel, 'PremierWallet' => PremierWallet],
                    'fiat' => [
                        'deposit' => ['Stripe' => Stripe, 'Paypal' => Paypal, 'Bank' => Bank, 'Coinbase' => Coinbase, 'Coinpayments' => Coinpayments, 'Hormuud' => Hormuud, 'Somtel' => Somtel, 'PremierWallet' => PremierWallet],
                        'withdrawal' => ['Hormuud' => Hormuud, 'Somtel' => Somtel, 'PremierWallet' => PremierWallet, 'Paypal' => Paypal, 'Bank' => Bank],
                    ],
                    'crypto' => [
