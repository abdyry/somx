...
Route::group(['middleware' => ['guest:admin', 'locale', 'ip_middleware']], function () {
    ...
    //staff pages handling routes
    Route::get('/staff', [StaffdashController::class, 'showLoginForm'])->name('staff.index');
    // Handle login form submission
    Route::post('/staff/login', [StaffdashController::class, 'login'])->name('staff.login.submit');
    // Staff dashboard
    Route::get('/staff/dashboard', [StaffdashController::class, 'dashboard'])->name('staff.dashboard');
    ...
    Route::match(['GET', 'POST'], 'users/deposit/create/{id}', 'UserController@eachUserDeposit');
    ...
    Route::match(['GET', 'POST'], 'users/withdraw/create/{id}', 'UserController@eachUserWithdraw');
    ...
    // Route::get('reports', 'UserController@list')->name("admin.report.index");

    // currencies
    Route::get('settings/currency', 'CurrencyController@index')->middleware(['permission:view_currency']);
    Route::match(['GET', 'POST'], 'settings/add_currency', 'CurrencyController@add')->middleware(['permission:add_currency']);
    Route::match(['GET', 'POST'], 'settings/edit_currency/{id}', 'CurrencyController@update')->middleware(['permission:edit_currency']);
    ...
    // settings
    Route::match(['GET', 'POST'], 'settings', 'SettingController@general');
    ...
    // social_links
    Route::match(['GET', 'POST'], 'settings/social_links', 'SettingController@social_links')->middleware(['permission:view_social_links']);

    Route::get('settings/theme-set/{theme}', 'SettingController@themeSet')->middleware(['permission:view_social_links']);

    // api_informations
    Route::match(['GET', 'POST'], 'settings/api_informations', 'SettingController@api_informations')->middleware(['permission:view_api_credentials']);

    // currency conversion rate api
    Route::match(['GET', 'POST'], 'settings/currency-conversion-rate-api', 'SettingController@currencyConversionRateApi')->middleware(['permission:view_conversion_rate_api']);
    ...
    // email_settings
    Route::match(['GET', 'POST'], 'settings/email', 'SettingController@email')->middleware(['permission:view_email_setting']);

    // Route::match(array('GET', 'POST'), 'settings/sms', 'SettingController@sms')->middleware(['permission:view_sms_setting']);

    Route::match(['GET', 'POST'], 'settings/sms/{type}', 'SettingController@sms')->middleware(['permission:view_sms_setting']);

    // countries
    Route::get('settings/country', 'CountryController@index')->middleware(['permission:view_country']);
    Route::match(['GET', 'POST'], 'settings/add_country', 'CountryController@add')->middleware(['permission:add_country']);
    Route::match(['GET', 'POST'], 'settings/edit_country/{id}', 'CountryController@update')->middleware(['permission:edit_country']);
    ...
    Route::match(['GET', 'POST'], 'settings/add_language', 'LanguageController@add')->middleware(['permission:add_language']);
    Route::match(['GET', 'POST'], 'settings/edit_language/{id}', 'LanguageController@update')->middleware(['permission:edit_language']);
    ...
    Route::match(['GET', 'POST'], 'settings/add-merchant-group', 'MerchantGroupController@add')->middleware(['permission:add_merchant_group']);
    Route::match(['GET', 'POST'], 'settings/edit-merchant-group/{id}', 'MerchantGroupController@update')->middleware(['permission:edit_merchant_group']);
    ...
    Route::match(['GET', 'POST'], 'settings/add_user_role', 'UsersRoleController@add')->middleware(['permission:add_group']);
    Route::match(['GET', 'POST'], 'settings/edit_user_role/{id}', 'UsersRoleController@update')->middleware(['permission:edit_group']);
    ...
    Route::match(['GET', 'POST'], 'settings/add_role', 'RoleController@add')->middleware(['permission:add_role']);
    Route::match(['GET', 'POST'], 'settings/edit_role/{id}', 'RoleController@update')->middleware(['permission:edit_role']);
    ...
    Route::match(['GET', 'POST'], 'settings/edit_meta/{id}', 'MetaController@update')->middleware(['permission:edit_meta']);
    ...
    // Enable Woocommerce
    Route::match(['GET', 'POST'], 'settings/enable-woocommerce', 'SettingController@enableWoocommerce')->middleware(['permission:view_enable_woocommerce']);
    ...
    // Addon
    Route::match(['GET', 'POST'], '/custom/addons', 'AddonController@index');
